...
@SpringBootTest
public class AgentExecutorExITest {
        ...
        while (true) {
            ...
            if (output.isEND()) {
                ...
                if (returnValue.isInterruptionMetadata()) {
                    ...
                    input = switch( call ) {
                        case TestWithApprove -> GraphInput.resume(Map.of(AgentEx.APPROVAL_RESULT_PROPERTY, "APPROVED"));
                        case testWithReject -> GraphInput.resume(Map.of(AgentEx.APPROVAL_RESULT_PROPERTY, "REJECTED"));
                    };
