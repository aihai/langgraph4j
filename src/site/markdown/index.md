...
| Date         | Release        | info
|--------------|----------------| ---
| Apr 27, 2026 | `1.8.14` | official release
...
```xml
<properties>
    <langgraph4j.version>1.8.14</langgraph4j.version> <!-- Check for the actual latest version -->
</properties>
...
<dependency>
    <groupId>org.bsc.langgraph4j</groupId>
    <artifactId>langgraph4j-core</artifactId>
    <version>1.8.14</version> <!-- Or the current snapshot version -->
</dependency>
```
