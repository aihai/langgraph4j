...
| Date         | Release        | info
|--------------|----------------| ---
| May 11, 2026 | `1.8.16` | official release
...
```xml
<properties>
    <langgraph4j.version>1.8.16</langgraph4j.version> <!-- Check for the actual latest version -->
</properties>
...
<dependency>
    <groupId>org.bsc.langgraph4j</groupId>
    <artifactId>langgraph4j-core</artifactId>
    <version>1.8.16</version> <!-- Or the current snapshot version -->
</dependency>
```
